...
class StEstadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create st_estado" do
    assert_difference('StEstado.count') do
      post st_estados_url, params: { st_estado: { aprobacion: @st_estado.aprobacion, destinos: @st_estado.destinos, destinos_admin: @st_estado.destinos_admin, orden: @st_estado.orden, st_estado: @st_estado.st_estado, st_modelo_id: @st_estado.st_modelo_id } }
    end
  ...
  test "should update st_estado" do
    patch st_estado_url(@st_estado), params: { st_estado: { aprobacion: @st_estado.aprobacion, destinos: @st_estado.destinos, destinos_admin: @st_estado.destinos_admin, orden: @st_estado.orden, st_estado: @st_estado.st_estado, st_modelo_id: @st_estado.st_modelo_id } }
