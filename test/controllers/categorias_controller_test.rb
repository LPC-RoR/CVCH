...
class CategoriasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categoria" do
    assert_difference('Categoria.count') do
      post categorias_url, params: { categoria: { base: @categoria.base, categoria: @categoria.categoria, perfil_id: @categoria.perfil_id } }
    end
  ...
  test "should update categoria" do
    patch categoria_url(@categoria), params: { categoria: { base: @categoria.base, categoria: @categoria.categoria, perfil_id: @categoria.perfil_id } }
