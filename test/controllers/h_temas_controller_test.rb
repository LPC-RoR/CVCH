...
class HTemasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create h_tema" do
    assert_difference('HTema.count') do
      post h_temas_url, params: { h_tema: { activo: @h_tema.activo, credito_imagen: @h_tema.credito_imagen, detalle: @h_tema.detalle, imagen: @h_tema.imagen, orden: @h_tema.orden, tema: @h_tema.tema } }
    end
  ...
  test "should update h_tema" do
    patch h_tema_url(@h_tema), params: { h_tema: { activo: @h_tema.activo, credito_imagen: @h_tema.credito_imagen, detalle: @h_tema.detalle, imagen: @h_tema.imagen, orden: @h_tema.orden, tema: @h_tema.tema } }
