...
class BlgArticulosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blg_articulo" do
    assert_difference('BlgArticulo.count') do
      post blg_articulos_url, params: { blg_articulo: { app_perfil_id: @blg_articulo.app_perfil_id, articulo: @blg_articulo.articulo, blg_articulo: @blg_articulo.blg_articulo, blg_tema_id: @blg_articulo.blg_tema_id, descripcion: @blg_articulo.descripcion, estado: @blg_articulo.estado, imagen: @blg_articulo.imagen } }
    end
  ...
  test "should update blg_articulo" do
    patch blg_articulo_url(@blg_articulo), params: { blg_articulo: { app_perfil_id: @blg_articulo.app_perfil_id, articulo: @blg_articulo.articulo, blg_articulo: @blg_articulo.blg_articulo, blg_tema_id: @blg_articulo.blg_tema_id, descripcion: @blg_articulo.descripcion, estado: @blg_articulo.estado, imagen: @blg_articulo.imagen } }
