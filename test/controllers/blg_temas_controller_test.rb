...
class BlgTemasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blg_tema" do
    assert_difference('BlgTema.count') do
      post blg_temas_url, params: { blg_tema: { blg_tema: @blg_tema.blg_tema, descripcion: @blg_tema.descripcion, imagen: @blg_tema.imagen } }
    end
  ...
  test "should update blg_tema" do
    patch blg_tema_url(@blg_tema), params: { blg_tema: { blg_tema: @blg_tema.blg_tema, descripcion: @blg_tema.descripcion, imagen: @blg_tema.imagen } }
