...
class EvaluacionesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evaluacion" do
    assert_difference('Evaluacion.count') do
      post evaluaciones_url, params: { evaluacion: { aspecto: @evaluacion.aspecto, evaluacion: @evaluacion.evaluacion, investigador_id: @evaluacion.investigador_id, publicacion_id: @evaluacion.publicacion_id } }
    end
  ...
  test "should update evaluacion" do
    patch evaluacion_url(@evaluacion), params: { evaluacion: { aspecto: @evaluacion.aspecto, evaluacion: @evaluacion.evaluacion, investigador_id: @evaluacion.investigador_id, publicacion_id: @evaluacion.publicacion_id } }
