...
class BlgImagenesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blg_imagen" do
    assert_difference('BlgImagen.count') do
      post blg_imagenes_url, params: { blg_imagen: { blg_imagen: @blg_imagen.blg_imagen, credito_imagen: @blg_imagen.credito_imagen, imagen: @blg_imagen.imagen } }
    end
  ...
  test "should update blg_imagen" do
    patch blg_imagen_url(@blg_imagen), params: { blg_imagen: { blg_imagen: @blg_imagen.blg_imagen, credito_imagen: @blg_imagen.credito_imagen, imagen: @blg_imagen.imagen } }
