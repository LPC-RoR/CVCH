...
class AppObservacionesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create app_observacion" do
    assert_difference('AppObservacion.count') do
      post app_observaciones_url, params: { app_observacion: { detalle: @app_observacion.detalle, owner_class: @app_observacion.owner_class, owner_id: @app_observacion.owner_id } }
    end
  ...
  test "should update app_observacion" do
    patch app_observacion_url(@app_observacion), params: { app_observacion: { detalle: @app_observacion.detalle, owner_class: @app_observacion.owner_class, owner_id: @app_observacion.owner_id } }
