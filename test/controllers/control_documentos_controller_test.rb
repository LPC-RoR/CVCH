...
class ControlDocumentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create control_documento" do
    assert_difference('ControlDocumento.count') do
      post control_documentos_url, params: { control_documento: { control: @control_documento.control, descripcion: @control_documento.descripcion, nombre: @control_documento.nombre, o_clss: @control_documento.o_clss, o_id: @control_documento.o_id, orden: @control_documento.orden, tipo: @control_documento.tipo } }
    end
  ...
  test "should update control_documento" do
    patch control_documento_url(@control_documento), params: { control_documento: { control: @control_documento.control, descripcion: @control_documento.descripcion, nombre: @control_documento.nombre, o_clss: @control_documento.o_clss, o_id: @control_documento.o_id, orden: @control_documento.orden, tipo: @control_documento.tipo } }
